...
# SIMA anlaysis directories
dirs = ['stica_0ol.sima', 'stica_20ol.sima', 'stica_50ol.sima',
        'stica_5mu.sima', 'stica_9mu.sima', 'stica_50pca.sima',
        'stica_75pca.sima']
